...
/**
 * The primary key class for the TR_TABLE_EIK database table.
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
@Embeddable
public class TrTableEikPK implements Serializable {
    ...
    @Column(name = "KEY_ABRECH_NR", length = 5, columnDefinition = "CHAR(5)")
    @Size(max = 5)
    private String keyAbrechNr;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        TrTableEikPK other = (TrTableEikPK) obj;
        return Objects.equals(keyAbrechNr, other.keyAbrechNr) && Objects.equals(keyIdNr, other.keyIdNr)
                && keyLaufnummer == other.keyLaufnummer && keyMeldejahr == other.keyMeldejahr
                && Objects.equals(keyMuster, other.keyMuster) && Objects.equals(keySatzart, other.keySatzart)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(keyAbrechNr, keyIdNr, keyLaufnummer, keyMeldejahr, keyMuster, keySatzart, keySysDatum,
                keyUhrzeit, mandSl);
    }
}
