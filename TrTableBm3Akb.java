...
/**
 * The persistent class for the TR_TABLE_AKB database table for records
...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "TR_TABLE_AKB")
public class TrTableBm3Akb extends TrTableAkb implements Serializable {
