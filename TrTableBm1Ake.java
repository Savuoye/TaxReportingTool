...
/**
 * The persistent class for the TR_TABLE_AKE database table for records
...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "TR_TABLE_AKE")
public class TrTableBm1Ake extends TrTableAke implements Serializable {
    private static final long serialVersionUID = 1L;

    // Foreign Key for TrTableBM1
    @ManyToOne
    @JoinColumns({
