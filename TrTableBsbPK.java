...
@NoArgsConstructor
@Embeddable
public class TrTableBsbPK implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        TrTableBsbPK other = (TrTableBsbPK) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(keyIdNr, keyLaufnummer, keyMeldejahr, keyMuster, keySysDatum, keyUhrzeit, mandSl);
    }
}
